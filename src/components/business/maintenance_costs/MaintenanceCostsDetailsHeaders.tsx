...
interface MaintenanceCostsDetailsHeadersProps {
    title?: string;
}

const MaintenanceCostsDetailsHeaders = (props: MaintenanceCostsDetailsHeadersProps) => {
    return (
...
export default MaintenanceCostsDetailsHeaders;