...
class RawMaterialPediatricDefaults extends DefaultsRawMaterialsBase<RawMaterialGroupModel> {
    ...
    protected setCommons_MixingCentral_Manual(inItem: RawMaterialGroupModel): void {
        this.setClinicalInput(inItem.AguaEsteril_500ml, 500.00, 0, 1.00, 0, 4000.00, 0); // 4000.00
    ...
    protected setOthers_MixingCentral_Manual(inItem: RawMaterialGroupModel): void {
        ...
        this.setClinicalInput(inItem.Bolsa1000Ml, 1.00, 0, 0, 0, 21000.00, 0); //21000.00
        ...
        this.setClinicalInput(inItem.VitaminasLiposolublesInfantil, 1.00, 0, 1.00, 0, 13000.00, 0); //13000.00
    }
